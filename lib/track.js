...
(function() {
  var Logger, Path, Track, async, cleanEmptyDirs, clone, deepMap, domain, fixPathPiece, fs, getSpotID, id3, makeB64, mkdirp, objTypeof, process, ref, request, sformat,
  ...
  Track = (function() {
    ...
    Track.prototype.createDirs = function() {
      var _path, err, error, fields, fixStrg, i, j, len, len1, o, pathFormat, ref1, ref2, ref3, ref4, stats, trackCopy;
    ...
    Track.prototype.downloadFile = function() {
      ...
      return d.run((function(_this) {
        return function() {
          var err, error;
          _this.out = fs.createWriteStream(_this.file.path + ".tmp");
          try {
    ...
    Track.prototype.writeMetadata = function() {
      ...
      id3.write(meta, this.file.path + ".tmp");
      fs.unlink(meta.image);
      fs.rename(this.file.path + ".tmp", this.file.path);
      return typeof this.callback === "function" ? this.callback() : void 0;
    };
